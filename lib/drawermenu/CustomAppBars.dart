...
class MyCustomAppBars extends StatelessWidget {
  ...
  MyCustomAppBars({Key? key, this.onPressed , this.profileUrl , this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
        ...
        builder:(context , int value , widget){
          print("Noti value ${value}");
          return Container(
            child: Row(
              children: [
                title.toString().toLowerCase()=="profile"?
                Container():
                InkWell(
                  onTap:onPressed,
                  child: Container(
