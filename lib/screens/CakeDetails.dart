  ...
  Future<void> loadOrderPreference() async{
    ...
    setState((){
      if(vendorName.isEmpty){
        ...
        vendorAddress = nearestVendors[selVendorIndex]['Address']['FullAddress'];
                                  ...
                                  Container(
                                    ...
                                    child:( cakeRatings != null)?(cakeRatings != 'null')?Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13,
                                        fontFamily: poppins)):Text(cakeRatings),
                                  )
                                ],
                              ),
                              Row(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  customweightCtrl.text.isEmpty||double.parse(customweightCtrl.text)<6.0||
                                    ...
                                    onPressed: () async{
                                      ...
                                      if(newRegUser==true){
                                        ...
                                        if(mySelVendors.isNotEmpty){
                                          ...
                                          if(fixedWeight=='0.0'||fixedDelliverMethod==""||
                                          ...
                                          else if(userAddress.isEmpty||userAddress=="null"||userAddress==null){
                                            ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(
                                            ...
                                            setState((){
                                              vendorName = mySelVendors[0]['VendorName'];
                                              vendorID = mySelVendors[0]['VendorId'];
                                              vendorMobileNum = mySelVendors[0]['VendorPhone'];
                                              vendorModID = mySelVendors[0]['VendorModId'];
                                              vendorAddress = mySelVendors[0]['VendorAddress'];
                                            });
